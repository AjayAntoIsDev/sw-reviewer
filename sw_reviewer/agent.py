...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        '---\n\n'
        '## Output Instructions\n\n'
        'After performing all stages, you MUST do EXACTLY these two steps:\n\n'
        '### Step 1: Call `review_generate_pdf`\n\n'
        'This is your FINAL tool call. You MUST call `review_generate_pdf` with a single '
        '`review_json` argument — a JSON string with these keys:\n'
        ...
        '### Step 2: Present the review summary as markdown\n\n'
        'After the PDF is generated, present a short markdown summary with:\n'
