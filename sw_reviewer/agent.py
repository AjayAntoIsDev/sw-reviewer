...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        '1. **FIRST**, call `review_generate_pdf` to generate the PDF report. '
        ...
        '2. **THEN**, after the PDF tool call returns, present the final review as a '
        '**single markdown message** with these sections:\n'
        ...
        '⚠️ CRITICAL: You MUST call `review_generate_pdf` BEFORE writing your final summary. '
        'Do NOT write the review text first — call the tool first, then summarize. '
